    ...
    services: {
      ...
      builderPackages: [
        ...
        },
        {
          ...
          desc: 'A fully custom website built from scratch — not a template, not a theme, not something borrowed from another business. It loads fast, looks sharp on every device, and is built the right way so Google can find it. Best for businesses that want a site that works as hard as they do.',
        ...
        },
        {
          ...
          desc: 'Everything you need to sell online — your products listed, payments set up, and order confirmation emails handled automatically. For restaurants and food businesses, I can connect your site directly to Toast so customers order from your site and it goes straight to your kitchen.',
    ...
    services: {
      ...
      builderPackages: [
        ...
        },
        {
          ...
          desc: 'Un sitio web completamente personalizado, construido desde cero — sin plantillas, sin diseños prestados de otro negocio. Carga rápido, se ve bien en cualquier dispositivo y está construido de la manera correcta para que Google pueda encontrarlo. Ideal para negocios que quieren un sitio que trabaje tan duro como ellos.',
        ...
        },
        {
          ...
          desc: 'Todo lo que necesitas para vender en línea — tus productos publicados, pagos configurados y correos de confirmación automáticos. Para restaurantes y negocios de comida, puedo conectar tu sitio directamente con Toast para que los pedidos lleguen directo a tu cocina.',
